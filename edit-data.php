...
// Cek apakah parameter id_tamu ada di URL
if (isset($_GET['id_tamu'])) {
    $id_tamu = $_GET['id_tamu'];

    // Query untuk mengambil data tamu berdasarkan id_tamu
    $query = "SELECT tamu.id_tamu, tamu.nik, tamu.nama_tamu, tamu.no_hp, tamu.jenis_tamu AS instansi, tamu.keperluan, kunjungan.tanggal_kunjungan 
              FROM tamu
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Query untuk update data tamu
    $update_query = "UPDATE tamu 
                     SET nik = ?, nama_tamu = ?, no_hp = ?, jenis_tamu = ?, keperluan = ? 
                     WHERE id_tamu = ?";
    $stmt = $koneksi->prepare($update_query);
    $stmt->bind_param("sssssi", $nik, $nama_tamu, $no_hp, $instansi, $keperluan, $id_tamu);

    // Eksekusi query
    if ($stmt->execute()) {
        echo "Data berhasil diperbarui.";
        header("Location: table-tamu.php"); // Redirect ke halaman daftar tamu
        exit;
    } else {
                                ...
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_tamu" name="nama_tamu" value="<?php echo htmlspecialchars($data['nama_tamu']); ?>" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="instansi" name="instansi" value="<?php echo htmlspecialchars($data['instansi']); ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="keperluan">Keperluan</label>
                                            <textarea class="form-control" id="keperluan" name="keperluan" required><?php echo htmlspecialchars($data['keperluan']); ?></textarea>
                                        </div>
                                        <div class="form-group">
